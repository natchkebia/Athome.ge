          ...
          <div>
            ...
            <p>
              {en
                ...
                : "AtHome-ის კატალოგში წარმოდგენილია 6 000-ზე მეტი დასახელების პროდუქტი — წამყვანი მსოფლიო ბრენდების პროცესორები, ვიდეობარათები, დედაპლატები, ოპერატიული მეხსიერება, პერიფერიული მოწყობილობები, ლეპტოპები და საოფისე ტექნიკა, თითოეულ ნივთზე გადამოწმებული, ოფიციალური ტექნიკური მონაცემებით."}
            </p>
          </div>
        </article>
