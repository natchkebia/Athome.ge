...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  let data: { id?: number; name?: string; description?: string; logoUrl?: string; seo?: { metaTitle?: string; metaDescription?: string; ogImageUrl?: string } | null } | null = null;
  ...
  return {
    ...
    other: { ...entityMeta("brand", data?.id) },
  };
}
